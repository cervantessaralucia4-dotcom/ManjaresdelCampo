...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    const fallback = [
      ...
      {id:2,nombre:'Aguacate Hass',categoria:'Frutas',precio:3000,unidad:'und',badge:'ORGÁNICO',imagen_url:'https://images.unsplash.com/photo-1704960961383-67dd63756199?w=500&q=80',imagen_bg:'#f5eaf0'},
      ...
      {id:6,nombre:'Coco Fresco',categoria:'Frutas',precio:3500,unidad:'und',badge:'FRESCO',imagen_url:'https://images.unsplash.com/photo-1581453883350-288b2c19bea8?w=500&q=80',imagen_bg:'#f0ebe0'},
